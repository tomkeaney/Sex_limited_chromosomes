...
In an attempt to future proof the availability of our supplementary material, we also include the supplementary methods, Table S1-XX and Figures S1 in this document. Additionally, our raw data is deposited in the Dryad database **[update when appicable](XXX)**.
...
We performed the following crosses on mass to preserve genetic variation in our evolving population. **XX individuals were used...**
